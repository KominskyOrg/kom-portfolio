const projectData = [
  ...
  },
  {
    ...
    img: "/openai.svg",
    role: "Automation",
    desc: "Automated job screening pipeline using GPT-4 for role evaluation with deterministic gates for dealbreaker detection.",
    outcome: "Automates 80% of job screening with zero false positives on binary constraints.",
    url: "/projects/job-scanner",
    isCaseStudy: true,
    target: "_self",
  },
  {
